...
preds1<- ifelse(as.numeric(prob1) > 0.5, 1, 0)
# confusion matrix
...
y1 <- data.q1$fracture
cv.l1 <- cv.glmnet(x1,y1,family="binomial",nfolds = 5,alpha=1,penalty.factor =c(rep(0,6),rep(1,7),rep(0,12)))
l.mod1<- glmnet(x1,y1,family="binomial",alpha=1,lambda = best_lambda.l1,penalty.factor =c(rep(0,6),rep(1,7),rep(0,12)))
...
preds2<- ifelse(as.numeric(prob2) > 0.5, 1, 0)
# confusion matrix
...
set.seed(123)
cv.l.hip <- cv.glmnet(x.hip,y.hip,family="binomial",nfolds = 5,alpha=1,penalty.factor =c(rep(0,6),rep(1,7),rep(0,12)))
best_lambda.l.hip<-cv.l.hip$lambda.min
set.seed(123)
l.mod.hip<- glmnet(x.hip,y.hip,family="binomial",alpha=1,lambda = best_lambda.l.hip, 
                   penalty.factor =c(rep(0,6),rep(1,7),rep(0,12)))
...
BMDfeature.hip
##"DXXINBMD" "DXXWDBMD" "DXXL1BMD" "DXXL2BMD" "DXXL3BMD" "DXXL4BMD"
...
preds3<- ifelse(as.numeric(prob3) > 0.5, 1, 0)
# confusion matrix
...
BMDfeature.men
## "DXXINBMD" "DXXWDBMD" "DXXL1BMD" "DXXL2BMD" "DXXL3BMD"
...
preds4<- ifelse(as.numeric(prob4) > 0.5, 1, 0)
# confusion matrix
...
set.seed(123)
cv.l.women <- cv.glmnet(x.women,y.women,family="binomial",nfolds = 5,alpha=1,penalty.factor =c(rep(0,5),rep(1,7),rep(0,12)))
...
l.mod.women<- glmnet(x.women,y.women,family="binomial",alpha=1,lambda = best_lambda.l.women,
                     penalty.factor=c(rep(0,5),rep(1,7),rep(0,12)))
